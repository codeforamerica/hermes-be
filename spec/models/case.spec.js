...
describe('Case model', function() {
  ...
  describe('for normalizeCaseNumber', function() {
    ...
    it ('should normalize 12 CI 7000 to 12-CI-007000', function() {
      expect(models.case.normalizeCaseNumber('12 CI 7000')).toBe('12-CI-007000')
    }) // END it - should normalize 12 CI 7000 to 12-CI-007000
