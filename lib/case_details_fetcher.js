...
/*
    body = "
<div class='dataTitle'>COMMONWEALTH VS. CATTAN, JOSEPH RAY</div>

<div class='headerEvent'>
<label id="ctl00_ContentPlaceHolder_Content_repeat_cases_ctl01_repeat_events_ctl00_lbl_event_header">Scheduled Events</label>
</div>

<div>
<span class="itemEvent">PRETRIAL CONFERENCE</span>
<span class="itemEvent">4/22/2013&nbsp;09:00 AM</span>
<span>HJ302     </span>
</div>
"
*/
    ...
    caseDetails.title = $('div[class="dataTitle"]').text().trim()
    ...
    if (events) {
      ...
      caseDetails.nextCourtDateTime.setHours((nextDateTime[4] == 'AM') ? nextDateTime[2] : nextDateTime[2] + 12)
      caseDetails.nextCourtDateTime.setMinutes(nextDateTime[3])
